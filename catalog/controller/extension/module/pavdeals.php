...
class ControllerExtensionModulePavdeals extends Controller {
	...
	public function index($setting) { 
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('theme_default_directory') . '/stylesheet/pavdeals.css')) {
			$this->document->addStyle('catalog/view/theme/'.$this->config->get('theme_default_directory').'/stylesheet/pavdeals.css');
		} else {
		...
		// Render
		$template = '/extension/module/pavdeals/carousel_deals';
	...
	public function pavdeal($product = null){
		...
		if(!defined("PAVDEALS_LOADED_ASSETS")){
			if (file_exists(DIR_TEMPLATE . $this->config->get('theme_default_directory') . '/stylesheet/pavdeals.css')) {
				$this->mdata['style'] = 'catalog/view/theme/'.$this->config->get('theme_default_directory').'/stylesheet/pavdeals.css';
			} else {
		...
		if($is_product_detail){
			if (file_exists(DIR_TEMPLATE . $this->config->get('theme_default_directory') . '/template/extension/module/pavdeals/product_deal_detail.tpl')) {
				$this->template = $this->config->get('theme_default_directory') . '/template/extension/module/pavdeals/product_deal_detail.tpl';
			} else {
				$this->template = 'default/template/extension/module/pavdeals/product_deal_detail.tpl';
			}
			$output = $this->render();
		}else{
			if (file_exists(DIR_TEMPLATE . $this->config->get('theme_default_directory') . '/template/extension/module/pavdeals/item_deal.tpl')) {
				$this->template = $this->config->get('theme_default_directory') . '/template/extension/module/pavdeals/item_deal.tpl';
			} else {
