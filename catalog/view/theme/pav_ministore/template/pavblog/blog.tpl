    ...
    <?php } ?>
		...
		<div class="pav-blogs">
			...
			<?php if( $blog['thumb_large'] ) { ?>
				<img class="img-responsive space-10 space-padding-r20" alt="<?php echo $blog['title']; ?>" src="<?php echo $blog['thumb_large'];?>" title="<?php echo $blog['title'];?>"/>
			<?php } ?>	
			</div>
			<div class="blog-info">
				<div class="blog-detail">
					<div class="clearfix"></div>
					<h1 class="heading space-padding-tb-20"><?php echo $heading_title; ?></h1>
								...
								<form action="<?php echo $comment_action;?>" method="post" id="comment-form" class="form-horizontal space-top-20">
									<fieldset>
										...
										<div class="form-group required">
											<div class="col-sm-6">
												<input class="form-control" type="text" name="comment[user]" value="" placeholder="<?php if(isset($value) && $value){ echo $value; }else{ echo "Full Name";} ?>" id="comment-user"/>									
											</div>
											<div class="col-sm-6">									
												<input class="form-control" type="text" name="comment[email]" value="" placeholder="<?php if(isset($value) && $value){ echo $value; }else{ echo "Email";} ?>" id="comment-email"/>
											</div>								
										</div>
										<div class="form-group required">								
											<div class="col-sm-12">
